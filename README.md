...
| 想快速整理教材 | **Gemini Notebook（原 NotebookLM）** | 能把教材整理成摘要、簡報或音訊；社群 CLI 需另行評估風險 |
...
- Firebase Web API key 是公開識別資訊，資料安全要靠 Security Rules 與 App Check；Service Account private key 才是高度敏感秘密。
...
> 文件最後查證：2026-07-20。介面與連接器能力會變動，實際操作前以官方文件和目前工具清單為準。
